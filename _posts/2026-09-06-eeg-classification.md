---
title: "Zero-Shot Image Classification Using EEG Data"
layout: post
...
![CLIP CNN figure](../assets/images/eeg_classification.png){:style="display:block; margin:0 auto; width: 50%;"}
Custom built CLIP - CNN decoding pipeline (figure generated by Claude using an input of the hand-drawn pipeline) 
...
![Results figure](../assets/images/eeg_classification_graph.png){:style="display:block; margin:0 auto; width: 75%;"}
Zero-shot accuracy across participants for EEG decoding image classification using original AlexNet model (Replication of Gifford et al. (2022))
{:.image-caption; style="display:block; text-align:center;"}
...
### Acknowledgements
This project directly follows the paper ["A large and rich EEG dataset for modeling human visual object recognition"](https://www.sciencedirect.com/science/article/pii/S1053811922008758){:target="_blank"} by Alessandro T. Gifford, Kshitij Dwivedi, Gemma Roig, Radoslaw M. Cichy. The code to replicate the original results was forked from their GitHub repository. Data was accessed through [OSF](https://osf.io/3jk45/overview){:target="_blank"} and originates from the [THINGS Initiative](https://things-initiative.org/){:target="_blank"}. This project was done through the Duke University course COMPSCI 372: Introduction to Applied Machine Learning taught by [Dr. Brandon Fain](https://scholars.duke.edu/person/brandon.fain){:target="_blank"}. 